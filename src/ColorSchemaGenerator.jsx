...
const ColorSchemaGenerator = ({ resetTrigger, colorSettingsData, setColorSettingsData, schemaType, setSchemaType }) => {
    ...
    return (
        <div className="bg-stone-900 basis-3/12 rounded w-full overflow-hidden" >
            ...
            <div style={{ scrollbarWidth: "none" }}>
                ...
                <ColorSettings resetTrigger={resetTrigger} colorSettingsData={colorSettingsData} setColorSettingsData={setColorSettingsData} />}
...
export default ColorSchemaGenerator