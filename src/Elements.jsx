    ...
    <>
      <div className="p-3 space-y-4 overflow-y-scroll max-h-[650px]" style={{ scrollbarWidth: "none" }}>
        <div className="bg-stone-700 h-10 p-3 w-full flex items-center space-x-2">
          ...
          <input
            className="flex w-full focus:ring-0 focus:outline-none bg-transparent text-white placeholder-gray-300"
            placeholder="Search"
            value={searchTerm}
         ...
         {filtered.map((el, index) => (  
          <div 
            key={index} 
            className="bg-stone-700 h-10 px-3 py-10 w-full flex items-center space-x-2 cursor-grab"
            draggable 
          ...
          > 
            ...
            <div>
              <h4 className="text-lg font-semibold leading-5 text-white">{el.title}</h4>
